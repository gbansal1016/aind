...
def custom_score(game, player):
    ...
    distance = abs(y_own - y_opp) + abs(x_own - x_opp)
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        for move in moves:
            ...
            val = self.min_value(new_game,depth,1)
            if val > best_val:
                best_val = val
                best_move = move
    ...
    def max_value(self, game, depth, curr_level):
        ...
        for move in legal_moves:
            ...
            minimizer = self.min_value(next_state, depth, curr_level )
    ...
    def min_value(self, game, depth, curr_level):
        ...
        for move in legal_moves:
            next_state = game.forecast_move(move)
            maximizer = self.max_value(next_state, depth, curr_level )
